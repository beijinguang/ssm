...
public class SSDB{
	...
	/* setx */
	public void setx(byte[] key, byte[] val,  byte[] time) throws Exception{
		Response resp = link.request("setx", key, val, time);
		if(resp.ok()){
			return;
		}
		resp.exception();
	...
	public void setx(String key, String val, long time) throws Exception{
	...
	public byte[] hsize(String key)  throws Exception {
	...
	public  byte[]  ttl(String key) throws Exception {
